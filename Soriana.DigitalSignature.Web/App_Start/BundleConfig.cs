...
namespace Soriana.DigitalSignature.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/budles/sweetalert").Include(
            ...
            bundles.Add(new ScriptBundle("~/bundles/jqueryImpresor").Include(
